...
import com.qy.customview.sweet_alert_dialog.SweetAlertDialog;
import com.qy.main.R;


public class SweetAlertDialogActivity
        extends
        Activity
        implements
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.custom_img_test:
				new SweetAlertDialog(this, SweetAlertDialog.CUSTOM_IMAGE_TYPE).setTitleText("Sweet!").setContentText("Here's a custom image.").setCustomImage(R.drawable.ic_launcher).show();
				break;
